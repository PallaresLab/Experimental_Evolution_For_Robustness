...
#Last plot should show integration of all traits in a form of a heatmap.
...
wing_variation = ShapeDist(shapes = dummy_heatmap[, coords], reference = mshape(dummy_heatmap[, specify corods here]))
...
robustness_heatmap = rbind(wing_variation,size_robustness,flight_robustness,ai_robustness) #this dataframe contains between 1000 - 1200 values for all traits.
...
pheatmap(df_heatmap, cluster_rows = FALSE,
         cluster_cols = F,
         show_rownames=F,
         show_colnames = T,
